...
export default function AdminDashboard() {
  ...
  // Camera Modal State (Supports tournament, group, team, player)
  ...
  // Camera Handling & Image Compression (prevents 1MB Firestore limit breach)
  ...
  const capturePhoto = async () => {
    ...
    // Scale down resolution for compressed lightweight storage (max width 640px)
    ...
    // Compress image quality to 0.7 JPEG to keep size well under Firestore 1MB limits
    ...
    try {
      ...
      alert("Failed to save photo: Size may still exceed Firestore document limits.");
    }
  };
        ...
        <main className="p-4 sm:p-5 flex-1 overflow-y-auto max-w-7xl w-full mx-auto space-y-5">
          ...
          {activeTab === "groups_teams" && currentTournament && (
            <div className="space-y-4">
              ...
              {/* GROUPS, TEAMS, PLAYERS & PHOTOS TREE (WITH GROUP PHOTO LEVEL) */}
